...
export default () => {
    return (
        <div className={styles.textContainer}>
            <h1>Politica e Privacidade Patrick &A</h1>

            <h3>Esta política é válida a partir de Feb 2022.</h3>

            <p>
                Política de Privacidade - Patrick &A
                Patrick &A, pessoa jurídica de direito privado leva a sua privacidade a sério e zela pela segurança e proteção de dados de todos os seus clientes, parceiros, fornecedores e usuários do site domínio https://www.patrick.com.br e qualquer outro site, loja ou aplicativo operado pelo lojista.
            </p>
            ...
            <p>Esta Política de Privacidade fornece uma visão geral de nossas práticas de privacidade e das escolhas que você pode fazer, bem como direitos que você pode exercer em relação aos Dados Pessoais tratados por nós. Se você tiver alguma dúvida sobre o uso de Dados Pessoais, entre em contato com petricksirqueira@gmail.com.</p>
...
<li>
                ...
                <li>
                    ...
                    Caso pretenda exercer qualquer um dos direitos previstos, inclusive retirar o seu consentimento, nesta Política de Privacidade e/ou nas Leis de Proteção de Dados, ou resolver quaisquer dúvidas relacionadas ao Tratamento de seus Dados Pessoais, favor contatar-nos em petricksirqueira@gmail.com.
                </li>
            </ul>
        </div>
    )
